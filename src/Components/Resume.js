...
const resumeContents =[{
    ...
    text:"oss ds fs fs s fs fs f sf ss fs fs fs fg t ete e te te te te te te te te te te te te te te te te te te te te"
},{
                ...
                <div className="skills">
                    ...
                    <SmallTitle icon={<BusinessCenter />} title="Working Experince"  />
                        ...
                        <div className="resume-content">
                            {
                                resumeContents.map(content=><ResumeItem key={content.year} {...content} />)
                            }
                        </div>
                 </div>
            </InnerLaout>
